  ...
  <div class="container">
    <div class="search-filters">
      <div class="search-container" id="main-search">
        <?php
        $booksql = "SELECT ISBN, Title FROM MEDIA";
        $generalresult = $conn-> query($sql);
        ?>
        <a href="#">
      ...
      <div class="search-row">
        <div class="sliding-tile-container">
          <div class="tile-container">
            <img class="tile" src="../assets/image.png">
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo '<img class="tile" src="../assets/image.png">';
              echo '<div class="title-text">' . $row['Title'] . '</div>';
              echo '<a href="addMedia.php?id=' . $row['ID'] . '"><button type="button" class="add-button">Add</button></a>';

          
            }
          } else {
            echo '<h1>No results for ' . $row['Title'] . '</h1>';
          }
          ?>
        </div>
      </div>
